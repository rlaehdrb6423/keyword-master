    ...
    <>
      ...
      <section className="max-w-5xl mx-auto mt-12 mb-8">
        <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 p-8">
          ...
          <h3 className="font-semibold text-gray-900 dark:text-white text-sm mb-3">주요 기능</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6">
            <div className="p-3 rounded-xl bg-gray-50 dark:bg-gray-800/50">
              <h4 className="font-medium text-gray-900 dark:text-white text-xs mb-1">경쟁 블로그 주제 크롤링</h4>
              <p className="text-xs text-gray-500 dark:text-gray-400 leading-relaxed">
                입력한 경쟁 블로그의 최근 포스팅 주제를 자동으로 수집합니다. 네이버 블로그, 티스토리, 워드프레스를 모두 지원합니다.
              </p>
            </div>
            <div className="p-3 rounded-xl bg-gray-50 dark:bg-gray-800/50">
              <h4 className="font-medium text-gray-900 dark:text-white text-xs mb-1">틈새 주제 발굴</h4>
              <p className="text-xs text-gray-500 dark:text-gray-400 leading-relaxed">
                경쟁 블로그에는 있지만 내 블로그에는 없는 주제를 자동으로 필터링합니다. 중복 주제를 제외하고 새로운 콘텐츠 아이디어만 추천합니다.
              </p>
            </div>
            <div className="p-3 rounded-xl bg-gray-50 dark:bg-gray-800/50">
              <h4 className="font-medium text-gray-900 dark:text-white text-xs mb-1">검색량 기반 우선순위</h4>
              <p className="text-xs text-gray-500 dark:text-gray-400 leading-relaxed">
                추천된 틈새 주제 각각의 네이버 월간 검색량을 함께 표시합니다. 검색량이 높은 주제를 먼저 작성하면 트래픽 효과를 극대화할 수 있습니다.
              </p>
            </div>
            <div className="p-3 rounded-xl bg-gray-50 dark:bg-gray-800/50">
              <h4 className="font-medium text-gray-900 dark:text-white text-xs mb-1">로그인 전용 기능</h4>
              <p className="text-xs text-gray-500 dark:text-gray-400 leading-relaxed">
