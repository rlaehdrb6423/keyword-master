      ...
      <div className="card p-4 mb-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-3 text-sm">
          <div className="flex items-center gap-2">
            <GradeBadge grade="A" /> <span className="text-gray-600 dark:text-gray-400">매우 좋음 (50+)</span>
          </div>
          <div className="flex items-center gap-2">
            <GradeBadge grade="B" /> <span className="text-gray-600 dark:text-gray-400">좋음 (20~50)</span>
          </div>
          <div className="flex items-center gap-2">
            <GradeBadge grade="C" /> <span className="text-gray-600 dark:text-gray-400">보통 (5~20)</span>
          </div>
          <div className="flex items-center gap-2">
            <GradeBadge grade="D" /> <span className="text-gray-600 dark:text-gray-400">어려움 (5 미만)</span>
          </div>
          <div className="flex items-center gap-2">
          ...
          {entries.map((entry) => (
            <div key={entry.keyword} className="card p-5">
              ...
              <div className="grid grid-cols-2 gap-2 text-sm text-gray-600 dark:text-gray-400">
                ...
                <div>
                  <span className="text-gray-400 dark:text-gray-500">문서수</span>
