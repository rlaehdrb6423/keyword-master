  ...
  return (
    <div className="max-w-3xl mx-auto py-8">
      ...
      <div className="bg-white rounded-2xl border border-gray-100 p-8">
        ...
        <p className="text-sm text-gray-500 mb-8">시행일: 2026년 3월 27일</p>
        ...
        <div className="space-y-8 text-sm text-gray-700 leading-relaxed">
          ...
          <section>
            ...
            <h3 className="font-medium text-gray-800 mb-2 mt-4">네이버 로그인</h3>
            ...
            <h3 className="font-medium text-gray-800 mb-2 mt-4">구글 로그인</h3>
            <ul className="space-y-1.5 list-none pl-3">
              <li className="flex gap-2">
                <span className="text-gray-400 flex-shrink-0">-</span>
            ...
            <h3 className="font-medium text-gray-800 mb-2 mt-4">서비스 이용 과정에서 자동 수집되는 정보</h3>
            <ul className="space-y-1.5 list-none pl-3">
              <li className="flex gap-2">
                <span className="text-gray-400 flex-shrink-0">-</span>
          ...
          <section>
            ...
            <ul className="space-y-2 list-none">
              ...
              <li className="flex gap-2">
                <span className="text-gray-400 flex-shrink-0">5.</span>
          ...
          <section>
            ...
            <h3 className="font-medium text-gray-800 mb-2 mt-5">개인정보 처리 위탁</h3>
            <p className="mb-3">서비스는 원활한 운영을 위해 다음과 같이 개인정보 처리를 위탁합니다.</p>
            <div className="overflow-x-auto">
              <table className="w-full text-xs border-collapse">
                <thead>
                  <tr className="bg-gray-50">
                    <th className="text-left p-3 border border-gray-200 font-medium text-gray-700">수탁 업체</th>
                    <th className="text-left p-3 border border-gray-200 font-medium text-gray-700">위탁 업무</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    <td className="p-3 border border-gray-200 text-gray-600">Vercel Inc.</td>
                    <td className="p-3 border border-gray-200 text-gray-600">서비스 호스팅 및 서버 운영</td>
                  </tr>
                  <tr className="bg-gray-50/50">
                    <td className="p-3 border border-gray-200 text-gray-600">Upstash Inc.</td>
                    <td className="p-3 border border-gray-200 text-gray-600">이용 횟수 데이터 저장(Redis)</td>
                  </tr>
                  <tr>
                    <td className="p-3 border border-gray-200 text-gray-600">Google LLC</td>
                    <td className="p-3 border border-gray-200 text-gray-600">소셜 로그인, 서비스 이용 분석(GA4)</td>
                  </tr>
                  <tr className="bg-gray-50/50">
                    <td className="p-3 border border-gray-200 text-gray-600">Microsoft Corporation</td>
                    <td className="p-3 border border-gray-200 text-gray-600">서비스 이용 행태 분석(Clarity)</td>
                  </tr>
                  <tr>
                    <td className="p-3 border border-gray-200 text-gray-600">Meta Platforms Inc.</td>
                    <td className="p-3 border border-gray-200 text-gray-600">광고 성과 측정(Meta Pixel)</td>
                  </tr>
                  <tr className="bg-gray-50/50">
                    <td className="p-3 border border-gray-200 text-gray-600">Naver Corp.</td>
                    <td className="p-3 border border-gray-200 text-gray-600">소셜 로그인</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <section>
            ...
            <h3 className="font-medium text-gray-800 mb-2">사용 목적</h3>
            ...
            <h3 className="font-medium text-gray-800 mb-2">쿠키 거부 방법</h3>
            <p>
          ...
          <section>
            ...
            <div className="bg-gray-50 rounded-xl p-4 space-y-1.5">
              <p><span className="text-gray-500">담당자:</span> 키워드뷰 운영자</p>
              <p>
          ...
          <div className="pt-4 border-t border-gray-100">
            ...
            <p className="text-gray-500 mt-1">
              문의:{" "}
              <a href="mailto:rlaehdrb6423@gmail.com" className="underline hover:text-gray-700 transition-colors">
                rlaehdrb6423@gmail.com
              </a>
            </p>
          </div>
