        ...
        <div className="bg-whitegray-900 rounded-2xl border border-gray-100 p-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6">
            <div className="p-3 rounded-xl bg-gray-50gray-800/50">
              <h4 className="font-medium text-gray-900 text-xs mb-1">PC/모바일 검색량</h4>
              <p className="text-xs text-gray-500 leading-relaxed">
                네이버 검색광고 API에서 제공하는 최근 30일 기준 월간 검색량입니다. PC와 모바일을 분리하여 사용자 행동 패턴을 파악할 수 있습니다.
              </p>
            </div>
            <div className="p-3 rounded-xl bg-gray-50gray-800/50">
              <h4 className="font-medium text-gray-900 text-xs mb-1">채널별 경쟁도</h4>
              <p className="text-xs text-gray-500 leading-relaxed">
                네이버 검색 API로 블로그, 뉴스, 카페 각 채널의 문서 수를 조회합니다. 채널별 점유율 차트로 어떤 채널에서 경쟁이 심한지 시각적으로 확인할 수 있습니다.
              </p>
            </div>
            <div className="p-3 rounded-xl bg-gray-50gray-800/50">
              <h4 className="font-medium text-gray-900 text-xs mb-1">A~D 등급 평가</h4>
              <p className="text-xs text-gray-500 leading-relaxed">
                검색량/문서수 비율로 등급을 산출합니다. A등급(추천) → B등급(양호) → C등급(보통) → D등급(경쟁 치열) 순으로, 블로그 글 작성 우선순위를 쉽게 정할 수 있습니다.
              </p>
            </div>
            <div className="p-3 rounded-xl bg-gray-50gray-800/50">
              <h4 className="font-medium text-gray-900 text-xs mb-1">관련 키워드 10개</h4>
              <p className="text-xs text-gray-500 leading-relaxed">
