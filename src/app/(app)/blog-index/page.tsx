        ...
        <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 p-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6">
            <div className="p-3 rounded-xl bg-gray-50 dark:bg-gray-800/50">
              <h4 className="font-medium text-gray-900 dark:text-white text-xs mb-1">11단계 블로그 레벨</h4>
              <p className="text-xs text-gray-500 dark:text-gray-400 leading-relaxed">
                총 포스팅 수, 주간 포스팅 빈도, 평균 본문 길이, 검색 노출률을 종합하여 Lv.1부터 Lv.11까지의 레벨을 산출합니다. 레벨이 높을수록 검색 엔진에서 더 잘 노출됩니다.
              </p>
            </div>
            <div className="p-3 rounded-xl bg-gray-50 dark:bg-gray-800/50">
              <h4 className="font-medium text-gray-900 dark:text-white text-xs mb-1">포스팅 빈도 분석</h4>
              <p className="text-xs text-gray-500 dark:text-gray-400 leading-relaxed">
                최근 포스팅의 작성 주기를 주간 단위 타임라인 차트로 시각화합니다. 규칙적인 포스팅 습관이 블로그 지수 향상에 핵심적인 역할을 합니다.
              </p>
            </div>
            <div className="p-3 rounded-xl bg-gray-50 dark:bg-gray-800/50">
              <h4 className="font-medium text-gray-900 dark:text-white text-xs mb-1">포스트별 SEO 점수</h4>
              <p className="text-xs text-gray-500 dark:text-gray-400 leading-relaxed">
                각 포스트의 제목 길이, 본문 길이, 키워드 검색량, 구조 등 9가지 SEO 항목을 100점 만점으로 평가합니다. 개선이 필요한 항목별로 구체적인 팁을 제공합니다.
              </p>
            </div>
            <div className="p-3 rounded-xl bg-gray-50 dark:bg-gray-800/50">
              <h4 className="font-medium text-gray-900 dark:text-white text-xs mb-1">검색 노출률</h4>
              <p className="text-xs text-gray-500 dark:text-gray-400 leading-relaxed">
          ...
          <h3 className="font-semibold text-gray-900 dark:text-white text-sm mb-3">지원 플랫폼</h3>
