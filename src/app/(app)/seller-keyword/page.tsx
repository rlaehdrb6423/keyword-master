  ...
  return (
    <>
      ...
      <section className="max-w-5xl mx-auto mt-12 mb-8">
        <div className="bg-whitegray-900 rounded-2xl border border-gray-100 p-8">
          ...
          <h3 className="font-semibold text-gray-900 text-sm mb-3">분석 항목</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6">
            <div className="p-3 rounded-xl bg-gray-50gray-800/50">
              <h4 className="font-medium text-gray-900 text-xs mb-1">검색량 vs 상품수</h4>
              <p className="text-xs text-gray-500 leading-relaxed">
                월간 PC/모바일 검색량과 네이버 쇼핑 탭의 전체 상품수를 비교합니다. 검색량은 높은데 상품수가 적은 키워드가 틈새 시장입니다.
              </p>
            </div>
            <div className="p-3 rounded-xl bg-gray-50gray-800/50">
              <h4 className="font-medium text-gray-900 text-xs mb-1">검색량/상품수 비율</h4>
              <p className="text-xs text-gray-500 leading-relaxed">
                비율이 1 이상이면 검색 수요가 상품 공급보다 많다는 의미입니다. 비율이 높을수록 경쟁 우위를 확보하기 유리합니다.
              </p>
            </div>
            <div className="p-3 rounded-xl bg-gray-50gray-800/50">
              <h4 className="font-medium text-gray-900 text-xs mb-1">블로그 마케팅 경쟁도</h4>
              <p className="text-xs text-gray-500 leading-relaxed">
                해당 키워드의 블로그 문서수도 함께 확인합니다. 블로그 체험단, 리뷰 마케팅이 많은 키워드는 광고비 경쟁도 치열할 수 있습니다.
              </p>
            </div>
            <div className="p-3 rounded-xl bg-gray-50gray-800/50">
              <h4 className="font-medium text-gray-900 text-xs mb-1">관련 키워드 비교</h4>
              <p className="text-xs text-gray-500 leading-relaxed">
